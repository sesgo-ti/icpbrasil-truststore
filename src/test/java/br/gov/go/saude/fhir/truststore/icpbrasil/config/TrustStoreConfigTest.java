...
class TrustStoreConfigTest {
    ...
    void testValidateUrls_ComCertificateUrlVazia_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("URL do Certificado: Não pode ser nulo ou vazio"));
    }
    ...
    void testValidateUrls_ComHashUrlVazia_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("URL do Hash: Não pode ser nulo ou vazio"));
    }
    ...
    void testValidateNetworkConfig_ComTimeoutInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("Timeout de Download: Deve ser entre 30 e 300 segundos"));
    }
    ...
    void testValidateNetworkConfig_ComMaxRetriesInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("Máximo de Tentativas: Deve ser entre 1 e 10"));
    }
    ...
    void testValidateNetworkConfig_ComRetryIntervalInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("Intervalo entre Tentativas: Deve ser entre 10 e 300 segundos"));
    }
    ...
    void testValidateCacheConfig_ComCacheTtlCriticoInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("TTL Crítico: Deve ser entre 24 e 168 horas"));
    }
    ...
    void testValidateCacheConfig_ComCacheTtlMaxInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("TTL Máximo: Deve ser entre 168 e 720 horas"));
    }
    ...
    void testValidateCacheConfig_ComRefreshIntervalInvalido_DeveLancarExcecao() {
        ...
        assertTrue(exception.getMessage().contains("Intervalo de Refresh: Deve estar entre 1 e o TTL Crítico"));
    }
